...
class JsonConf
{
  public:
    ...
    char get_data_delay               [16] = "10"                 ;
    char publish_delay                [16] = "10"                 ;
    char subscribe_delay              [16] = "60"                 ;
    char motion_read_delay            [16] = "10"                 ;
    char reboot_delay                 [16] = "1800"               ;

    char sys_log_host                 [16] = "192.168.2.50"       ;
